...
#define heat4xPeriod 5 * 60 * 1000L      // период включения нагрева SHT4x
#define isDarkPeriod 1000                // период проверки состояния освещенности на улице
#define heat3xBorder 75                  // значение влажности, выше которого включается нагрев датчика SHT3x
#define heat4xBorder 80                  // значение влажности, выше которого включается нагрев датчика SHT4x
